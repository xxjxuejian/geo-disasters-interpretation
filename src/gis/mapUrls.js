...
const mapUrls = {
  ...
  "tian-roadLabel": `http://t{0-7}.tianditu.gov.cn/DataServer?T=cta_w&x={x}&y={y}&l={z}&tk=${webKey}`,
  "tian-label": `http://t{0-7}.tianditu.gov.cn/DataServer?T=cva_w&x={x}&y={y}&l={z}&tk=${webKey}`,
  "tian-vec": `http://t{0-7}.tianditu.gov.cn/DataServer?T=vec_w&x={x}&y={y}&l={z}&tk=${webKey}`,
  "tian-ter": `http://t{0-7}.tianditu.gov.cn/DataServer?T=ter_w&x={x}&y={y}&l={z}&tk=${webKey}`,
  /** *
   *geoq地图
